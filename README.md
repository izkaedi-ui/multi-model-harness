...
| 📜 **Decision Provenance** | `pytest tests/unit/test_decision_provenance.py` | `reports/decision_provenance.json` | `checks.decision_provenance == true` | Decisions are canonicalized, SHA-256 hashed, HMAC-authenticated, and sequence-linked. |
